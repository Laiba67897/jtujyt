        ...
        case "path":
          object = (
            <path
              ...
              strokeLinecap={element.props.strokeLinecap}
              key={i}
            />
          );
          break;
      ...
      switch (element.type) {
        case "gradient":
          object = (
            <D3Gradient
              id={element.props.id}
              color1={element.props.color1}
              color2={element.props.color2}
            />
          );
          break;
      }
    ...
    render: function () {
      ...
      return (
        <div>
          ...
          >
            {defs}
            <g transform={this.transform}>{elements}</g>
          </svg>
        </div>
      );
    },
    ...
    render: function () {
      return (
        <div className="panel-header">
          ...
          <div className="pull-right line-height-30">{this.props.children}</div>
        </div>
      );
    }
  });
      ...
      return (
        <div className="row">
          <div className="col-md-12 custom_padding">
            <Panel>
              <PanelHeader title="Traffic Trend"></PanelHeader>
              <D3TimeLineChart
                data={data}
                xData="date"
                yData="count"
